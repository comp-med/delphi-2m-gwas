...
## Script to run the first step of REGENIE on the individual-level's embeddings
...
#! set name
#SBATCH --output=slurm-step1-emb.out
...
## Do some logging
echo "Run REGENIE step1 on embeddings phenotype file"
...
--bsize 1000 \
--lowmem \
--lowmem-prefix gwas/tmpdir/regenie_step1_emb120 \
--out gwas/input/emb120/ukb_emb_step1 \
--gz
