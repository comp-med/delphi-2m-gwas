...
## Script to run the first step of REGENIE on the male-only embeddings

#SBATCH --job-name=emb_male
...
#! set name
#SBATCH --output=slurm-step1-emb-male.out
...
## Do some logging
echo "Run REGENIE step1 on male embeddings phenotype file"
...
--bsize 1000 \
--lowmem \
--lowmem-prefix gwas/tmpdir/regenie_step1_emb120_male \
--out gwas/input/emb120_male/ukb_emb_male_step1 \
--gz
